...
## How the type of character and length associated with the strength of password?
...
Therefore, it can be concluded that most people choose common passwords that can be easily hacked and that using any of the passwords in the dataset is not recommended. 

In addition, because of the positive relationship between the password length and password strength, as well as the impact of password characteristics on password safety. This report would recommend that users should try to increase the password length to improve password security when signing up accounts. Meanwhile, the users could use a more complex password combination, like numbers and characters mixed to increase the strength of passwords. The pure numbers passwords would not be recommended because of the low password strength. 
