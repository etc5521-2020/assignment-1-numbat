...
Another important basis to judge the strength of a password, is to analyze the time taken to crack it. Table \@ref(tab:rankings) lists the time to crack the top 10 most popular passwords and is sorted by the popularity rank.
